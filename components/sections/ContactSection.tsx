  ...
  return (
    <section className="contact section-pad" id="contact">
      ...
      <div className="contact-actions">
        <a className="button button-accent" href="mailto:dsgnclave@gmail.com">Book a project <Arrow /></a>
        <a className="text-link light-link" href="mailto:dsgnclave@gmail.com">Contact me <Arrow /></a>
      </div>
      <div className="opportunity">
        <span>Looking for someone to join your team?</span>
        <a href="mailto:dsgnclave@gmail.com">Available for opportunities <Arrow /></a>
      </div>
      <footer>

...
export function FooterReel() {
  ...
  return (
    <footer
      id="contact"
      className="relative z-30 bg-[#0f0f0e] text-[#eeeae2] pt-20 md:pt-32 pb-12 px-6 md:px-16 lg:px-24 flex flex-col justify-between min-h-[80vh]"
    >
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-between">
        {/* Main Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-20 md:mb-32">
          {/* Left Column: Clean "Let's Connect." Headline & Direct Email */}
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-white leading-[1.05]">
              Let’s Connect.
            </h2>
